...
<form class="example" action="action_page.php">
  ...
  <div class="text-box">
        ...
        <div class="menu">
			<ul>
				<p>Data Wilayah Administratif</p>
			</ul>
</div>

      
        <div class="desc">
          <h2>Batas Wilayah Desa Kemiriombo</h2>
          <h3>SEBELAH UTARA</h3>
          <p>Desa Leksono Kecamatan Leksono.</p>
         <h3>SEBELAH SELATAN</h3>
         <P>Kelurahan Kaliwiro Kecamatan Kaliwiro.</P>
         <h3>SEBELAH TIMUR</h3>
         <P>Desa Sukoreno Kecamatan Kaliwiro.</P>
         <h3>SEBELAH BARAT</h3>
         <P>Desa Tanjunganom Kecamatan Kaliwiro.</P>
