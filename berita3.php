...
<div class="menu-tengah">
            <div class="kotak">
                ...
                <img src="berita4.jpg" alt="Sate Ayam">
 
                <p>
                Program Kementrian Kordinator PMK untuk Pesasaran Percepatan Penghapusan Kemiskinan Ekstrem (P3KE) kiranya harus tepat sasaran terarah, terpadu dan terus berkelanjutan.
                Hal itu disampaikan oleh Dodi Camat Kaliwiro Kabupaten Wonosobo saat bersama Pratikno Kepala Desa Kemiriombo dalam acara verifikasi dan validasi data warga masyarakat P3KE yang berhak untuk mendapatkannya.
                "Acara verivikasi dan validasi data P3KE yang dilakukan pemerintah, pemerintah daerah, dan atau masyarakat merupakan bentuk kebijakan, program dan kegiatan pemberdayaan masyarakat dalam pendampingan serta fasilitasi untuk memenuhi kebutuhan dasar setiap warga negara.
                Menurut Camat Dodi, Target sasaran verifikasi validasi data P3KE harus akurat sejalan dengan data Kemenkes, BPS, Kementerian Sosial dan BKKBN. Tandasnya (Sugito)
            </div>
        </div>
