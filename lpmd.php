...
<form class="example" action="action_page.php">
  ...
  <div class="text-box">
        ...
        <div class="desc">
          <h2>Tugas Dan Kewajiban LPMD</h2>
          <h3>Tugas</h3>
          <p>1. menyusun rencana pembangunan secara partisipatif melalui musrenbang.</p>
          <p>2. melaksanakan, mengendalikan, memanfaatkan, memelihara dan mengembangkan pembangunan secara partisipatif.</p>
          <p>3. menggerakkan dan mengembangkan partisipasi, gotong royong dan swadaya masyarakat.</p>
          <p>4. menumbuhkembangkan kondisi dinamis masyarakat dalam rangka pemberdayaan masyarakat.</p>
         <h3>Kewajiban</h3>
         <P>1. Memegang teguh dan mengamalkan Pancasila dan Undang-Undang Dasar 1945 serta mempertahankan dan memelihara Negara Kesatuan Republik Indonesia.</P>
         <P>2. Menjalin hubungan kemitraan dengan berbagai pihak yang terkait;</P>
         <P>3. Mentaati seluruh peraturan perundang-undangan.</P>
         <P>4. Menjaga nilai-nilai sosial budaya, adat istiadat dan norma-norma yang hidup dan berkembang di masyarakat.</P>
         <P>5. Membantu Pemerintah Desa dalam pelaksanaan kegiatan pemerintahan, pembangunan dan pembinaan masyarakat dalam rangka meningkatkan kesejahteraan masyarakat.</P>
      </div>
