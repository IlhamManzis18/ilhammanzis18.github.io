...
<form class="example" action="action_page.php">
  ...
  <div class="text-box">
        ...
        <div class="desc">
          <h2>Visi Dan Misi</h2>
          <h3>VISI</h3>
          <p>Terwujudnya Sumber daya Manusia yang seksama dengan meningkatkan kwalitas pelayanan masyarakat secara adil, merata dan berkelanjutan dengan tetap bertumpu pada kemandirian pemberdayaan masyarakat.
             Bahwa VISI merupakan pandangan jauh kedepan kemana arah dan tujuan Desa Kemiriombo untuk berkarya agar tetap eksis dalam pembangunan dan Pemerintahan Desa untuk meningkatkan kesejahteraan masyarakat.</p>
         <h3>MISI</h3>
         <P>1. Meningkatkan kwalitas pelayanan segala bidang.</P>
         <P>2. Meningkatkan Koordinasi dan pembinaan Pemerintah Desa</P>
         <P> 3. Meningkatkan pembinaan kemasyarakatan aspirasi terhadap kegiatan masyarakat.</P>
      </div>
